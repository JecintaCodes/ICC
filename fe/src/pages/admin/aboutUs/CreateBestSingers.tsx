...
const CreateBestSingers = () => {
  return (
    <div className='w-[100%] h-[100%] flex justify-center '>
    <div className="mt-[50px]">
        <div className="font-semibold text-[15px]">Create BestSingers</div>
        <form className="w-[350px] mt-[5px] min-h-[600px] border p-2 rounded-[3px] ">
         ...
         <div className=" gap-[10px] mt-[20px] flex justifuy-center items-center ">
          <div className="text-[15px] font-bold">Name:</div>
          <input 
          className="w-[90%] h-[50px] font-medium text-[13px] border outline-none p-2 "
          type="text"
             />
         </div>
         <div className=" gap-[10px] mt-[20px] flex justifuy-center items-center ">
          <div className="text-[15px] font-bold">Part:</div>
          <input 
          className="w-[90%] h-[50px] font-medium text-[13px] border outline-none p-2 "
          type="text"
             />
...
export default CreateBestSingers