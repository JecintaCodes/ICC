import img from "../../../assets/jec.jpg"

const OldMembersAndFriends = () => {
  return (
    <div className='w-[100%] h-[100%] flex justify-center '>
        <div className="mt-[50px]">
            <div className="font-semibold text-[15px]">Create OldMembersAndFriends</div>
...
export default OldMembersAndFriends