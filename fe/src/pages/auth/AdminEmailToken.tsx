...
const AdminEmailToken = () => {
    return (
      <div className="w-[100%] h-[100vh] flex justify-center bg-[dodgerblue] ">
          <div className="w-[90%] flex justify-center items-center  ">
          {/* card */}
            <form className="w-[400px] h-[300px] mobile:w-[100%] bg-white p-5 rounded-md ">
              <center>
                <div className=" text-[15px] font-semibold mt-[17px] text-[dodgerblue] mobile:w-[100%] ">input the 8 digit Token From Email</div>
                {/* inputHolder */}
  ...
  export default AdminEmailToken