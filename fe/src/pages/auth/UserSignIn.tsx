    ...
    <div className="w-[100%] h-[100vh] flex justify-center bg-[dodgerblue] ">
        ...
        {/* card */}
          <form className="min-w-[400px] min-h-[300px] bg-white p-5 rounded-md ">
            <center>
              <div className=" text-[17px] font-semibold mt-[15px]  ">SignIN</div>
              {/* inputHolder */}
           ...
           <Link to="/forget-password-user">
           <div className="mt-2 w-[400px] h-[30px]  flex justify-center items-center text-[dodgerblue] font-medium ">
            ...
            <div className=" mt-2 w-[400px] rounded-[5px] flex items-center gap-[50px] font-medium bg-[dodgerblue] h-[50px] p-5 ">
              ...
              <div className=" text-[15px] font-semibold text-[white] ">Signin with Facebook</div>
            </div>
            ...
            <div className=" mt-2 w-[400px] rounded-[5px] flex items-center gap-[50px] font-medium  h-[50px] p-5 border-[silver] border-[1px] ">
              ...
              <div className=" text-[15px] font-semibold text-[dodgerblue] ">Signin with Google</div>
            </div>
            {/* end icons */}
            </center>
